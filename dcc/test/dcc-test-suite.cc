...
class DccTestCase1 : public TestCase
{
public:
  DccTestCase1 ();
  virtual ~DccTestCase1 ();
...
DccTestCase1::DccTestCase1 ()
  : TestCase ("Dcc test case (does nothing)")
{
}
...
//
class DccTestSuite : public TestSuite
{
public:
  DccTestSuite ();
};

DccTestSuite::DccTestSuite ()
  : TestSuite ("dcc", UNIT)
{
  // TestDuration for TestCase can be QUICK, EXTENSIVE or TAKES_FOREVER
  AddTestCase (new DccTestCase1, TestCase::QUICK);
}

// Do not forget to allocate an instance of this TestSuite
static DccTestSuite dccTestSuite;
